...
class Blockchain{
    ...
    createGenesisBlock(){
        var date = new Date();
        return new Block(0, date.toDateString(), "Bloco inicial da koreCoin", "0");
    }
...
koreCoin.addBlock(new Block (4, "15/03/2020", {amount: 80}));
koreCoin.addBlock(new Block (5, "16/03/2020", {amount: 120}));
